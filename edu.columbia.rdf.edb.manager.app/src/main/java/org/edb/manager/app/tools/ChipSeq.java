...
public class ChipSeq {
	public static void main(String[] args) throws SQLException, IOException, ParseException {
		...
		try {
			...
			idfjava.nio.file.Path = new File("/mnt/hddb/experimentdb/data/experiments/chip_seq/katia_20140310/data.idf");
			
			experimentId = Experiments.createExperimentFromIdf(connection, 
					idfFile, 
					"basso_8");
			...
			sdrfjava.nio.file.Path = new File("/mnt/hddb/experimentdb/data/experiments/chip_seq/katia_20140310/data.sdrf");
			...
			*/
			...
			idfjava.nio.file.Path = new File("/mnt/hddb/experimentdb/data/experiments/chip_seq/melnick_oci_20160108/data.idf");
			...
			sdrfjava.nio.file.Path = new File("/mnt/hddb/experimentdb/data/experiments/chip_seq/melnick_oci_20160108/data.sdrf");
			createSamplesFromSDRF(connection,
					sdrfFile,
					experiment,
					person);
			*/
			...
			/*
			idfjava.nio.file.Path = new File("/mnt/hddb/experimentdb/data/experiments/chip_seq/katia_20151001/data.idf");
			...
			sdrfjava.nio.file.Path = new File("/mnt/hddb/experimentdb/data/experiments/chip_seq/katia_20151001/data.sdrf");
			createSamplesFromSDRF(connection,
					sdrfFile,
					experiment,
					person);
			...
			*/
			...
			/*
			idfjava.nio.file.Path = new File("/mnt/hddb/experimentdb/data/experiments/chip_seq/jiyuan_20150916/data.idf");
			...
			sdrfjava.nio.file.Path = new File("/mnt/hddb/experimentdb/data/experiments/chip_seq/jiyuan_20150916/data.sdrf");
			createSamplesFromSDRF(connection,
					sdrfFile,
					experiment,
					person);
			...
			*/
			...
			/*
			idfjava.nio.file.Path = new File("/mnt/hddb/experimentdb/data/experiments/chip_seq/katia_20150709/data.idf");
			...
			sdrfjava.nio.file.Path = new File("/mnt/hddb/experimentdb/data/experiments/chip_seq/katia_20150709/data.sdrf");
			createSamplesFromSDRF(connection,
					sdrfFile,
					experiment,
					person);
			*/
			...
			/*
			idfjava.nio.file.Path = new File("/mnt/hddb/experimentdb/data/experiments/chip_seq/melnick_1/data.idf");
			experimentId = Experiments.createExperimentFromIdf(connection, idfFile, "melnick-chipseq-1");
			experiment = Experiments.getExperiment(connection, experimentId);

			person = Persons.createPersonFromIdf(connection, idfFile);
			Persons.createRoleFromIdf(connection, idfFile);

			sdrfjava.nio.file.Path = new File("/mnt/hddb/experimentdb/data/experiments/chip_seq/melnick_1/data.sdrf");
			createSamplesFromSDRF(connection,
					sdrfFile,
					experiment,
					person);
			...
			experiment = 
					Experiments.getExperiment(connection, Experiments.createExperiment(connection, "Aster_001", "Aster Notch1", "Aster Notch1"));

			Organism organism = Experiments.createOrganism(connection, 
					"Human", 
					"Homo sapiens");
			...
			Person person = Persons.createPerson(connection, 
					"James",
					"Zou", 
					"Harvard University", 
					"617-301-0832", 
			...
			Type cellType = createCellType(connection, "CUTLL");
			Type chipType = createChipType(connection, "Transcription Factor");

			Type treatment = createTreatment(connection, "NOTCH1_1");

			createChipSeqSample(connection, 
					experiment,
					"Aster_CUTLL_Notch1_1_AS003",
					"AS003",
					chipType,
					cellType,
					treatment,
			...
			createChipSeqSample(connection, experiment,
					"Aster_CUTLL1_H3K27Ac_DMSO_AS014",
					"AS014",
					chipType,
					cellType,
					treatment,
			...
			createChipSeqSample(connection, experiment,
					"Aster_CUTLL1_H3K27Ac_w4h_AS012",
					"AS012",
					chipType,
					cellType,
					treatment,
			...
			experiment = 
					Experiments.getExperiment(connection, Experiments.createExperiment(connection, "Basso_20150-05-03", "Katia CB Test", "Katia CB Test"));

			organism = Experiments.createOrganism(connection, 
					"Human", 
					"Homo sapiens");
			...
			experiment = 
					Experiments.getExperiment(connection, Experiments.createExperiment(connection, "GE1", "MLL4 Mice", "MLL4 Mice"));
			...
			cellType = createCellType(connection, "GFP_preadipocytes");
			createChipSeqSample(connection, experiment,
					"Ge.GFP_preadipocytes.MLL4.GE002",
					"GE002",
					chipType,
					cellType,
					treatment,
			...
			createChipSeqSample(connection, experiment,
					"Ge.Cre_preadipocytes.MLL4.GE006",
					"GE006",
					chipType,
					cellType,
					treatment,
			...
			createChipSeqSample(connection, experiment,
					"Ge.MLL4_ChIPSeq_D2_WT.MLL4.GE010",
					"GE010",
					chipType,
					cellType,
					treatment,
			...
			createChipSeqSample(connection, experiment,
					"Ge.MLL4_ChIPSeq_D2_KO.MLL4.GE012",
					"GE012",
					chipType,
					cellType,
					treatment,
			...
			cellType = createCellType(connection, "GFP_preadipocytes");
			createChipSeqSample(connection, experiment,
					"Ge.GFP_preadipocytes.Input.GE001",
					"GE001",
					chipType,
					cellType,
					treatment,
			...
			cellType = createCellType(connection, "GFP_D5_myocytes");
			createChipSeqSample(connection, experiment,
					"Ge.GFP_D5_myocytes.Input.GE003",
					"GE003",
					chipType,
					cellType,
					treatment,
			...
			cellType = createCellType(connection, "Cre_preadipocytes");
			createChipSeqSample(connection, experiment,
					"Ge.Cre_preadipocytes.Input.GE005",
					"GE005",
					chipType,
					cellType,
					treatment,
			...
			cellType = createCellType(connection, "Cre_D5_myocytes");
			createChipSeqSample(connection, experiment,
					"Ge.Cre_D5_myocytes.Input.GE007",
					"GE007",
					chipType,
					cellType,
					treatment,
			...
			experiment = 
					Experiments.getExperiment(connection, Experiments.createExperiment(connection, "Basso_2015-03-12", "CB", "CB"));
			...
			experiment = 
					Experiments.getExperiment(connection, Experiments.createExperiment(connection, "Fabbri_2015-03-12", "MO1043", "MO1043"));
			...
			experiment = 
					Experiments.getExperiment(connection, Experiments.createExperiment(connection, "Basso_2014-10-09", "CB", "CB"));
			...
			//			person = Persons.createPerson(connection, "Louis", "Staudt", "Metabolism Branch Center for Cancer Research",  "National Cancer Institute, NIH, Bethesda, Maryland 20892, USA", TextUtils.NA);
			//
			//			chipType = createChipType(connection, "Transcription Factor");
			//
	...
	/*
	private static void addPeaksFromJson(Connection connection, 
			String name,
			String s1,
			String s2,
			String genome,
			...
			java.nio.file.Path file) throws SQLException, IOException {
		PreparedStatement statement;

		int id = -1;

		statement = connection.prepareStatement("SELECT chip_seq_peaks.id FROM chip_seq_peaks WHERE chip_seq_peaks.name = ? AND chip_seq_peaks.genome = ? AND chip_seq_peaks.peak_caller = ? AND chip_seq_peaks.peak_caller_parameters = ?");

		try {
			statement.setString(1, name);
			statement.setString(2, genome);
			statement.setString(3, peakCaller);
			statement.setString(4, peakCallerParameters);
		...
		if (id != -1) {
			...
			statement = connection.prepareStatement("DELETE FROM chip_seq_samples_peaks WHERE chip_seq_samples_peaks.peak_id = ?");
			...
			statement = connection.prepareStatement("DELETE FROM chip_seq_peaks WHERE chip_seq_peaks.id = ?");
		...
		statement = connection.prepareStatement("INSERT INTO chip_seq_peaks (name, genome, read_length, peak_caller, peak_caller_parameters, json_file) VALUES (?, ?, ?, ?, ?, ?)");

		try {
			statement.setString(1, name);
			statement.setString(2, genome);
			statement.setInt(3, readLength);
			statement.setString(4, peakCaller);
			statement.setString(5, peakCallerParameters);
			statement.setString(6, "peaks/" + PathUtils.getName(file));
		...
		statement = connection.prepareStatement("SELECT samples.id FROM samples WHERE samples.name LIKE ? LIMIT 1");
		...
		try {
			...
			sid1 = JDBCConnection.getInt(statement);
		} finally {
			statement.close();
		}
		...
		try {
			...
			sid2 = JDBCConnection.getInt(statement);
		} finally {
			statement.close();
		}

		statement = connection.prepareStatement("INSERT INTO chip_seq_samples_peaks (sample_id, peak_id) VALUES (?, ?)");

		try {
			statement.setInt(1, sid1);
	...
	*/
	...
	/*
	private static void addPeaksFromBedGraph(Connection connection, 
			String name,
			String s1,
			String s2,
			String genome, 
			String peakCaller,
			String peakCallerParameters, 
			java.nio.file.Path file) throws SQLException, IOException, ParseException {
		PreparedStatement statement;

		int id = -1;

		statement = connection.prepareStatement("SELECT peaks.id FROM peaks WHERE peaks.name = ? AND peaks.genome = ? AND peaks.peak_caller = ? AND peaks.peak_caller_parameters = ?");
		...
		if (id != -1) {
			...
			statement = connection.prepareStatement("DELETE FROM peak_locations WHERE peak_locations.peak_id = ?");
			...
			statement = connection.prepareStatement("DELETE FROM samples_peaks WHERE samples_peaks.peak_id = ?");
			...
			statement = connection.prepareStatement("DELETE FROM peaks WHERE peaks.id = ?");
		...
		statement = connection.prepareStatement("INSERT INTO peaks (name, genome, peak_caller, peak_caller_parameters) VALUES (?, ?, ?, ?)");
		...
		statement = connection.prepareStatement("INSERT INTO samples_peaks (sample_id, peak_id) VALUES (?, ?)");
		...
		try {
			...
			while ((line = reader.readLine()) != null) {
				...
				int start = TextUtils.parseInt(tokens.get(1)) + 1;
				int end = TextUtils.parseInt(tokens.get(2));
				double value = TextUtils.parseDouble(tokens.get(3));

				statement = connection.prepareStatement("INSERT INTO peak_locations (peak_id, chr, peak_start, peak_end, value) VALUES (?, ?, ?, ?, ?)");
	...
	*/
	...
	public static Type createChipType(Connection connection, String name) throws SQLException {
		return new Type(-1, name); //Types.createType(connection, "chip_seq_types", name);
	}

	public static Type createCellType(Connection connection, String name) throws SQLException {
		return new Type(-1, name); //Types.createType(connection, "cell_types", name);
	}

	public static Type createTreatment(Connection connection, String name) throws SQLException {
		return new Type(-1, name); //Types.createType(connection, "treatments", name);
	}
	...
	public static int createChipSeqSample(Connection connection, 
		...
		Type expressionType = 
				Samples.createExpressionType(connection, "ChIP-Seq");

		Type experimentField = 
				Tags.createTag(connection, Path.createRootPath("Experiment", "Name"));
		...
		Type field = 
				Tags.createTag(connection, Path.createRootPath("Sample", "Name"));
		...
		field = Tags.createTag(connection, Path.createRootPath("Sample", "Organism"));
		...
		field = Tags.createTag(connection, Path.createRootPath("Sample", "Expression_Type"));
	...
	public static void addSampleSearchTerms(Connection connection,
		...
		Type allField = Tags.createTag(connection, Path.createRootPath("ChIP-Seq", "All"));
	...
	public static void addSampleSearchTerm(Connection connection,
		...
		Type allField = 
				Tags.createTag(connection, Path.createRootPath("ChIP-Seq", "All"));
	...
	public static void createGEO(Connection connection, 
		...
		Type field = Tags.createTag(connection, Path.createRootPath("Sample", "GEO", "Series", "Accession"));

		addSampleSearchTerm(connection, sampleId, field, sa);

		field = Tags.createTag(connection, Path.createRootPath("Sample", "GEO", "Accession"));

		addSampleSearchTerm(connection, sampleId, field, a);

		field = Tags.createTag(connection, Path.createRootPath("Sample", "GEO", "Platform"));
	...
	public static void createSamplesFromSDRF(Connection connection, 
		...
		try {
			...
			while ((line = reader.readLine()) != null) {
				...
				String dataDir = TextUtils.cat(tokens.get(TextUtils.findFirst(header, 
						"Raw Data Directory")),
						name);
				...
				int sampleDirVfsId = VFS.createVfsDir(connection, 
						samplesVfsRootId, 
						name);
				...
				//	Files.createSampleFile2(connection, sampleId, tokens.get(i), Io.getFileExtension(tokens.get(i)));
				//}
			}
		} finally {
			reader.close();
	...
	public static int createSampleFile(Connection connection,
		...
		//java.nio.file.Path path = Io.createFile(dataDirectory, Io.concatenatePath(publicId, fileName));
