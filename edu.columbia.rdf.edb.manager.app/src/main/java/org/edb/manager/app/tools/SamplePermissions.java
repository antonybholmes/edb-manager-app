...
public class SamplePermissions {
	...
	public static void createViews(Connection connection,
		...
		PreparedStatement statement = 
				connection.prepareStatement("DELETE FROM sample_permissions WHERE sample_permissions.person_id = ?");
		...
		statement = connection.prepareStatement("INSERT INTO sample_permissions (sample_id, person_id) VALUES (?, ?)");
