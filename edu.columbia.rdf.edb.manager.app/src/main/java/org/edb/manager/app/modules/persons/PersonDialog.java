...
import org.edb.manager.app.tools.Persons;
...
public class PersonDialog extends ModernDialogTaskWindow implements ModernClickListener {
	...
	private ModernButton mGenPublicIdButton =
			new ModernDialogFlatButton("Generate");
	...
	private ModernButton mGenSaltButton =
			new ModernDialogFlatButton("Generate");
	
	private ModernButton mGenKeyButton =
			new ModernDialogFlatButton("Generate");
	...
	private void loadPerson(DatabaseResultsTable table) throws SQLException, ParseException {
