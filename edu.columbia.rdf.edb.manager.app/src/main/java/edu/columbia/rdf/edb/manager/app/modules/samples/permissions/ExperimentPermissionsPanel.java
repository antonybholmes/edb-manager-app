...
public class ExperimentPermissionsPanel extends ModernPanel {
  ...
  public ExperimentPermissionsPanel(Connection connection,
      MainManagerWindow window) throws SQLException {
    ...
    mExperimentsQuery = mQuery.select("id", "name").from("experiments");

    mExperimentPermissions = mQuery.select("id", "person_id", "experiment_id")
        .from("experiment_permissions").where("person_id");
