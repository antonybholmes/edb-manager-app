...
public class Files {
  ...
  public static int createDirectory(Connection connection,
    ...
    return createDirectory(connection,
        sampleId,
        PathUtils.toString(dataDirectory));
  }
  ...
  public static int createDirectory(Connection connection,
    ...
    PreparedStatement statement = connection.prepareStatement(
        "SELECT directories.id FROM directories WHERE directories.sample_id = ? AND directories.name = ?");
    ...
    statement = connection.prepareStatement(
        "INSERT INTO directories (sample_id, name) VALUES (?, ?)");
  ...
  public static int createSampleFile2(Connection connection,
    ...
    PreparedStatement statement = connection.prepareStatement(
        "SELECT files.id FROM files WHERE files.sample_id = ? AND files.name = ?");
    ...
    statement = connection.prepareStatement(
        "INSERT INTO files (sample_id, name, file_type_id) VALUES (?, ?, ?)");
  ...
  public static int createFileType(Connection connection, String fileName)
    ...
    PreparedStatement statement = connection.prepareStatement(
        "SELECT file_types.id FROM file_types WHERE file_types.name = ?");
    ...
    statement = connection
        .prepareStatement("INSERT INTO file_types (name) VALUES (?)");
