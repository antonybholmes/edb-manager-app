...
public class ExperimentPermissions {
	...
	public static void createViews(Connection connection,
		...
		statement = 
				connection.prepareStatement("DELETE FROM experiment_permissions WHERE experiment_permissions.person_id = ?");
		...
		statement = connection.prepareStatement("INSERT INTO experiment_permissions (experiment_id, person_id) VALUES (?, ?)");
