...
public class Version {
  public static void main(String[] args)
      throws SQLException, CryptographyException {
   ...
   * @throws SQLException
   */
  public static void createVersion(Connection connection, int version)
      throws SQLException {
    PreparedStatement statement = connection
        .prepareStatement("DELETE FROM version");
    ...
    statement = connection
        .prepareStatement("INSERT INTO version (version) VALUES (?)");
