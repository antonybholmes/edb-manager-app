...
public class Search {
  public static int createSearchCategory(Connection connection, String name)
      throws SQLException {
    return createSearchCategory(connection, Path.createRootPath(name));
  }

  public static int createSearchCategory(Connection connection, Path path)
      throws SQLException {

    String name = path.toString();

    PreparedStatement statement = connection.prepareStatement(
        "SELECT search_categories.id FROM search_categories WHERE search_categories.name = ?");
    ...
    statement = connection
        .prepareStatement("INSERT INTO search_categories (name) VALUES (?)");
  ...
  public static int createPrefix(Connection connection, String prefix)
      throws SQLException {

    String p = prefix.toLowerCase();

    PreparedStatement statement = connection.prepareStatement(
        "SELECT search_prefixes.id FROM search_prefixes WHERE search_prefixes.name = ?");
    ...
    statement = connection
        .prepareStatement("INSERT INTO search_prefixes (name) VALUES (?)");
  ...
  public static int createSearchSample(Connection connection,
    ...
    int searchFieldKeywordId = createSearchTagKeyword(connection,
        field,
        keywordId,
        keyword);

    PreparedStatement statement = connection.prepareStatement(
        "SELECT tags_samples_search.id FROM tags_samples_search WHERE tags_samples_search.tag_keyword_search_id = ? AND tags_samples_search.sample_id = ?");
    ...
    statement = connection.prepareStatement(
        "INSERT INTO tags_samples_search (tag_keyword_search_id, sample_id) VALUES (?, ?)");
  ...
  public static int createSearchTagKeyword(Connection connection,
    ...
    PreparedStatement statement = connection.prepareStatement(
        "SELECT tags_keywords_search.id FROM tags_keywords_search WHERE tags_keywords_search.tag_id = ? AND tags_keywords_search.keyword_id = ?");
    ...
    statement = connection.prepareStatement(
        "INSERT INTO tags_keywords_search (tag_id, keyword_id) VALUES (?, ?)");
  ...
  public static int createSearchExperiment(Connection connection,
    ...
    PreparedStatement statement = connection.prepareStatement(
        "SELECT search_experiments.id FROM search_experiments WHERE search_experiments.search_prefix_id = ? AND search_experiments.experiment_id = ?");
    ...
    statement = connection.prepareStatement(
        "INSERT INTO search_experiments (search_prefix_id, experiment_id) VALUES (?, ?)");
